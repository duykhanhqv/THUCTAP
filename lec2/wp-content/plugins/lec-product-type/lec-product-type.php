...
<?php
    ...
    public function lec2_checkout_field_display_admin($order)
    {
        ...
        echo '<p><strong>' . __('By as gift') . ':</strong> ' . (get_post_meta($order_id, 'client_checked_buy_as_gift', true) ? "yes" : "no") . '</p>';
    ...
    public function lec2_display_custom_fields_in_emails($ofields, $sent_to_admin, $order)
    {
        ...
        $custom_fields["client_checked_buy_as_gift"] = array('label' => __('By as gift'), 'value' => (get_post_meta($order_id, 'client_checked_buy_as_gift', true) ? "yes" : "no"));
    ...
    public function lec2_checkout_update_order_meta($order_id, $posted)
    {
        ...
        if (!empty($_POST['client_checked_buy_as_gift'])) {
            update_post_meta($order_id, 'client_checked_buy_as_gift', wc_clean($_POST['client_checked_buy_as_gift']));
        }
    }
}
