...
class Filters extends AbstractFilter
{
    ...
    public function checkoutFields($checkout)
    {
        ...
        // Check box by as gift
        //
        // 
        woocommerce_form_field('client_checked_buy_as_gift', array(
            'type'          => 'checkbox',
            'class'         => array('client_checked_buy_as_gift form-row-wide'),
            'label'   => __('Do you want buy we as gift.'),
        ), $checkout->get_value('client_checked_buy_as_gift'));
    ...
    // update_post_meta( $new_coupon_id, 'usage_limit', '/// email' );
